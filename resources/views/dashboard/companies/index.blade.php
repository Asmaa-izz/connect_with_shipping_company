...
@section('title', "جميع شركات الشحن")
...
@section('content')
    ...
    @component('dashboard.commonComponents.breadcrumb')
        ...
        @slot('page_now', "جميع شركات الشحن")
    @endcomponent
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="card-title d-flex justify-content-between align-items-center my-3">
                        <h4>جميع شركات الشحن</h4>
                        <a href="{{ route('companies.create') }}" class="btn btn-primary">إضافة شركة شحن جديد</a>
                    </div>
